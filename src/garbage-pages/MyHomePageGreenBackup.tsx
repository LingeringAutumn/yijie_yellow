...
import DialPanelModal from "../components/modals/DialPanelModal";
...
const MyHomePageContent: React.FC = () => {
	...
	const [isDialPanelModalOpen, setIsDialPanelModalOpen] = useState(false);
			...
			<div className="min-h-screen bg-[#f0f5f0] text-gray-800">
				<main className="flex-1 p-6">
					...
					{/*	<div className="col-span-5 mt-4">
						<button
							onClick={() => setIsDialPanelModalOpen(true)}
							className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xl rounded-lg"
						>
							调试：打开拨号面板模态框
						</button>
					</div>
					*/}
					...
					{/* 新增：拨号面板模态框，使用上下文状态 */}
					<DialPanelModal
						isOpen={isDialPanelModalOpen} // 从上下文中获取状态
						onClose={() => setIsDialPanelModalOpen(false)}
					/>
				</main>
			</div>
